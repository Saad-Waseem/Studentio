...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/doct')) {
            // doct
            if ($pathinfo === '/doct') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::createAction',  '_route' => 'doct',);
            }

            // productByID
            if (preg_match('#^/doct/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'productByID')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::showAction',));
            }
